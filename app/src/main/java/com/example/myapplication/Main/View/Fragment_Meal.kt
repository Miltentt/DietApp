...
fun next()
{
   meal_viewmodel.getRecipes(binding.mealtypeSpinner.selectedItem.toString(),binding.cuisineSpinner.selectedItem.toString(),binding.dietSpinner.selectedItem.toString())
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding.searchrecipes.setOnClickListener({v->next()})
